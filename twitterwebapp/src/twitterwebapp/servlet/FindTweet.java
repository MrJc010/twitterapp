 ...
 * 
 */
@WebServlet("/FindTweet")
public class FindTweet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String searchKey = (String)request.getParameter("FindT");
		result2.append(Manager.twitterAPI.findTweet(searchKey));
		...
		out.println("</div>");
		out.println("<div class=\"col-xs-3\">");
		out.println("<output type=\"body\">"+result2.toString()+"</output>");
		out.println("</div>	");
		out.println("</form>	");
		out.println("</div>");
		out.println("<br>");
