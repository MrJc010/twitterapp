...
public class Message extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String message = (String)request.getParameter("SendM");
		String person = (String)request.getParameter("SendU");
		result.append(Manager.twitterAPI.message(message, person));

		PrintWriter out = response.getWriter();		
		StringBuilder result2 = new StringBuilder();
		result2.append(Manager.twitterAPI.getUserName());
		...
		out.println("</form>");
		out.println("<div class=\"col-xs-3\">	");
		out.println("Message to " + person + " has been sent!");
		out.println("</div>");
