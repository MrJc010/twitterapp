...
//****************Viet Nguyen, Minh Ngo Code******************
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String yourtweet = (String)request.getParameter("PostT");
		result3.append(Manager.twitterAPI.postTweet(yourtweet ));
		...
		out.println("</div>");
		out.println("<div class=\"col-xs-3\">");
		out.println("<output type=\"body\">"+result3.toString()+"</output>");
		out.println("</div>");
		out.println("</form>");
