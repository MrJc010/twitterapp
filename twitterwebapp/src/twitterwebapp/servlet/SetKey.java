...
public class SetKey extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String consumerKey =(String)request.getParameter("apiKeyT");//"IiCSqSuOMTXPxPnGLKADD1XX3";//
		String consumerSecret = (String)request.getParameter("apiKeySeT");// "NOIjrwCFC1qKuNDXv8FNLJJMnQTLBwvnGeTaiSJlSE9LmqTtAV";//
		String accessToken = (String)request.getParameter("accessT");//"1042911030643326976-LEel2Go2h9Ad9ikucmfATXcpHluWvu";//
		String accessTokenSecret = (String)request.getParameter("accessSeT");//"rzZADaxFztjD6UehRyUoQ2FYr9NbAImuvCVciDlKFgRbK";//
		result.append(Manager.twitterAPI.setTwitterKey(consumerKey, consumerSecret, accessToken, accessTokenSecret));
		result1.append(Manager.twitterAPI.getUserName());
		...
		out.println("<form>");
		out.println("<p style=\"color:rgb(29, 161, 242)\"><output form=\"numform\" type=\"body\" name=\"x\" for=\"a b\">"+result1.toString()+"</output></p>");
		...
		out.println("<br>");
		out.println("<output  type=\"body\">Get Tweet Output</output>");
		out.println("</div>");
		out.println("</form>");
		out.println("<div class=\"col-xs-1\">");
		out.println("</div>");
